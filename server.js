// server.js – Version complète avec toutes les routes nécessaires
...
const fs = require('fs'); // pour débogage
...
// Servir les fichiers statiques (tous les fichiers du dossier courant)
app.use(express.static(__dirname));

// Route de débogage (optionnelle, à supprimer en production)
