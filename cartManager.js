...
// Impression de ticket : fenêtre se ferme automatiquement après impression
    ...
    return `
        ...
        <body>
            <div class="header">
                ...
                ${address ? `<div class="contact">${address}</div>` : ''}
            ...
            <div class="info-grid">
                <div class="info-item"><span class="label">Tiraj:</span> ${(ticket.draw_name || '').toUpperCase()}</div>
                <div class="info-item"><span class="label">Ticket #:</span> ${ticket.ticket_id || ticket.id}</div>
                <div class="info-item"><span class="label">Date:</span> ${new Date(ticket.date).toLocaleString('fr-FR')}</div>
                <div class="info-item"><span class="label">Ajan:</span> ${ticket.agent_name || APP_STATE.agentName}</div>
            </div>

            ${multiDrawNote}

            <div class="bets-header">DETAY PARAY</div>

            ${betsHtml || '<div style="text-align:center;">Pa gen paryaj</div>'}
