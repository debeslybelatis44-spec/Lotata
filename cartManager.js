...
window.printThermalTicket = printThermalTicket; // pour réimpression depuis uiManager.js
window.fallbackPrintTicket = fallbackPrintTicket; // gardé pour compatibilité
