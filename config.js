...
const CONFIG = {
    ...
    DRAWS: [
        ...
        { id: 'tn_soir', name: 'Tunisia Soir', time: '17:25', color: 'var(--tunisia)' },
        ...
        { id: 'tx_matin', name: 'Texas Matin', time: '10:55', color: 'var(--texas)' },
        { id: 'tx_soir', name: 'Texas Soir', time: '18:58', color: 'var(--texas)' }
    ],
